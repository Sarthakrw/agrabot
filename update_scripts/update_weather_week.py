...
json_file = 'data/data_en/weather/weather_week.json'
...
gemini_model=genai.GenerativeModel(
  ...
  system_instruction="""
You will be provided with 7 Day forcast document for the weather in Kenya. Your job is to fill in the answers using the information provided by the user only.
IMPORTANT : Only use the information provided in the official 7 Day forcast document to answer each question. DO NOT COME UP WITH YOUR OWN INFORMATION TO ANSWER THE QUESTION.
...
{
    "question": "What is the rainfall forecast for North-western Kenya (Turkana and Samburu Counties) this week?",
    "answer": "For the week of 23 to 29 July 2024, North-western Kenya (Turkana and Samburu Counties) can expect morning rains as well as afternoon and night showers and thunderstorms over few places."
}
...
url = "https://meteo.go.ke/forecast/7-days-forecast"
